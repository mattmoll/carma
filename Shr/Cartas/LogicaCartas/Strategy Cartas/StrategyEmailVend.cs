...
namespace Carm.Shr
{
    public class StrategyEmailVend : Strategy
    {
        StatMsg m_smResult = new StatMsg();

        // Llamamos al constructor del padre.
        public StrategyEmailVend(Bel.ECodigo p_eCodigo) : base(p_eCodigo) { }
        ...
        override public string dameString()
        {
            ...
            //Devolvemos el email del vendedor.
            return l_nvGetName.dameEmailVendedor();
        }
    }
}

...
namespace Carm.Tg
{
    ...
    //----------------------------------------------------------------------------
    // Fecha                     : 02/10/2013 15:45
    // Sistema                   : Carm
    // Interface para la Entidad : MotivosLlamada
    ...
    /// <summary>
    /// Formulario para Mantenimiento de la Tabla:MotivosLlamada
    /// </summary>
    public partial class MotivosLlamadas : DockContent
    {
        #region Miembros de la Clase
            private Bel.EMotivosLlamada m_entMotivosLlamada= null;
        ...
        /// </summary>
        private void MotivosLlamadas_Load(object sender, System.EventArgs e)
        {
            ...
            cmbCodcategoria.FillFromStrLEntidad(l_lentCategoriasLlamada, "ctl_rcd_cod", "ctl_des_des", "deleted");

            // Llenamos las Combos (por Lista)
            cmbEsReclamo.AddStrCD("S", "SI", 0);
            cmbEsReclamo.AddStrCD("N", "NO", 0);
        ...
        /// </summary>
        private void MotivosLlamadas_FormClosed(object sender, FormClosedEventArgs e)
        {
            // Liberamos el menu
            App.LockMenu(false);
        }
        ...
        private void grdDatos_HeaderClick(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left) {
                ...
                if (m_strSort != grdDatos.GridOrder) {
                    ...
                    App.SetStrURegistry(false, "GridFormat", "MotivosLlamadasGrdSort", m_strSort);
                    return;
                }
            }
        ...
        private void GrdColumn_WidthChanged(object sender, EventArgs e)
        {
            ...
            App.SetStrURegistry(false, "GridFormat", "MotivosLlamadasGrdWidths", grdDatos.ColWitdhs);
        }
        ...
        private void cmdExcel_Click(object sender, System.EventArgs e)
        {
            ...
            grdDatos.ExportToExcel(false, false, "", "MotivosLlamadas", m_smResult);
            App.EndAdvance();
            App.HideMsg();
        }
        ...
        private void gbNuevo_Click(object sender, System.EventArgs e)
        {
            ...
            // damos foco al primer campo
            m_entMotivosLlamada= Bel.EMotivosLlamada.NewEmpty();
        ...
        private void gbModificar_Click(object sender, System.EventArgs e)
        {
            ...
            m_entMotivosLlamada= Bll.Tablas.MtlGet((string) grdDatos.GetMatrixValueObj(l_iRow, 1),
                                                   false, m_smResult);
            if (MsgRuts.AnalizeError(this, m_smResult)) return;
            ...
            SwitchTo(FormModes.Edit, GridOps.DontFill);
            if (m_entMotivosLlamada.EstaBorrada) {
                gbCancelar.Focus();
            }
            else {
                cmbCodcategoria.Focus();
            }
            App.HideMsg();
        }
        ...
        private void gbCompactar_Click(object sender, EventArgs e)
        {
            ...
            if (MsgRuts.AskUser(this, "Atención!!!!\r\n" +
                                      ...
                                      /*App.Usuario.Usuario +*/ "MotivosLlamadasPurge") == DialogResult.No) return;

            // Purgamos la tabla
            App.ShowMsg("Compactando la tabla...");
            Bll.Tablas.MtlPurge(m_smResult);
            if (MsgRuts.AnalizeError(this, m_smResult)) return;
        ...
        private void gbChangeHabilitado_Click(object sender, System.EventArgs e)
        {
            ...
            Bll.Tablas.MtlEnabled(m_entMotivosLlamada.EstaBorrada,
                                  m_entMotivosLlamada.Cod,
                                  m_entMotivosLlamada.FxdVersion,
                                  m_smResult);
            if (MsgRuts.AnalizeError(this, m_smResult)) return;
        ...
        private void gbGrabar_Click(object sender, System.EventArgs e)
        {
            ...
            m_entMotivosLlamada.Cod= txtCod.Text;
            m_entMotivosLlamada.Des= txtDes.Text;
            m_entMotivosLlamada.Codcategoria= cmbCodcategoria.SelectedStrCode;
            m_entMotivosLlamada.Esreclamo = cmbEsReclamo.SelectedStrCode;

            // Tratamos de grabar la entidad
            App.ShowMsg("Grabando...");
            Bll.Tablas.MtlSave(m_entMotivosLlamada, m_smResult);
            if (MsgRuts.AnalizeError(this, m_smResult)) return;
        ...
        private void FillGrid()
        {
            ...
            App.ShowMsg("Recuperando datos...");
            Bel.LEMotivosLlamadas l_lentMotivosLlamadas= Bll.Tablas.MtlUpFull(false, m_smResult);
            if (MsgRuts.AnalizeError(this, m_smResult)) return;

            // Asignamos a la grilla
            App.InitAdvance("Cargando:");
            grdDatos.Focus();
            grdDatos.FillFromLEntidad(l_lentMotivosLlamadas, "deleted");
            grdDatos.ColWitdhs= App.GetStrURegistry(false, "GridFormat", "MotivosLlamadasGrdWidths", "");
            grdDatos.GridOrder= App.GetStrURegistry(false, "GridFormat", "MotivosLlamadasGrdSort", "");
            App.EndAdvance();

            // Fijamos el evento de cambio de ancho de la grilla
            if (l_lentMotivosLlamadas.Count > 0)
        ...
        private void OperationMode()
        {
            ...
            cmbCodcategoria.NormalDisable= true;
            cmbCodcategoria.Enabled= false;
            cmbEsReclamo.NormalDisable = true;
            cmbEsReclamo.Enabled = false;
            ...
            txtCod.Text= "";
            txtDes.Text= "";
            cmbCodcategoria.SelectedStrCode= "";
            cmbEsReclamo.SelectedStrCode = "";
        ...
        private void EditMode()
        {
            ...
            txtCod.Text= m_entMotivosLlamada.Cod;
            txtDes.Text= m_entMotivosLlamada.Des;
            cmbCodcategoria.SelectedStrCode= m_entMotivosLlamada.Codcategoria;
            cmbEsReclamo.SelectedStrCode = m_entMotivosLlamada.Esreclamo;

            // Habilitamos el frame
            txtCod.NormalDisable= false;
            txtCod.Enabled= m_entMotivosLlamada.EsNueva;
            txtDes.NormalDisable= false;
            txtDes.Enabled= m_entMotivosLlamada.EsNueva;
            cmbCodcategoria.NormalDisable= false;
            cmbCodcategoria.Enabled= !m_entMotivosLlamada.EstaBorrada;
            cmbEsReclamo.NormalDisable = false;
            cmbEsReclamo.Enabled = !m_entMotivosLlamada.EstaBorrada;
            gbCancelar.Enabled= true;
            gbGrabar.Enabled= !m_entMotivosLlamada.EstaBorrada;
            gbDeshabilitar.Enabled= ((!m_entMotivosLlamada.EsNueva) &&(!m_entMotivosLlamada.EstaBorrada));

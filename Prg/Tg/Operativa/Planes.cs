...
namespace Carm.Tg
{
    ...
    public partial class Planes : DockContent
    {
        ...
        private void cmdGrabar_Click(object sender, System.EventArgs e)
        {
            ...
            m_entPlan.Codplanavalon= txtCodplanavalon.Text;
            m_entPlan.Tcontratoavalon= txtTcontratoavalon.Text;
        ...
        private void OperationMode()
        {
            ...
            txtCodplanavalon.NormalDisable= true;
            txtCodplanavalon.Enabled= false;
            txtTcontratoavalon.NormalDisable= true;
            txtTcontratoavalon.Enabled= false;
            ...
            txtCod.Text= "";
            txtDes.Text= "";
            txtCodplanavalon.Text= "";
            txtTcontratoavalon.Text= "";
        ...
        private void EditMode()
        {
            ...
            txtCodplanavalon.Text= m_entPlan.Codplanavalon;
            txtTcontratoavalon.Text= m_entPlan.Tcontratoavalon;
            ...
            txtCodplanavalon.NormalDisable= false;
            txtCodplanavalon.Enabled= !m_entPlan.EstaBorrada;
            txtTcontratoavalon.NormalDisable= false;
            txtTcontratoavalon.Enabled= !m_entPlan.EstaBorrada;

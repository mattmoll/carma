...
namespace Carm.Dal
{
    ...
    // Sistema                  : Carm
    // Clase para Administrar   : Tipos de Contratos
    // Basada en la Tabla       : TipoCont
    //----------------------------------------------------------------------------
    ...
    /// <summary>
    /// Modulo DAL de Acceso a la tabla: TipoCont
    /// </summary>
    public static class TipoCont
    {
        //---------------------------------------------------------------

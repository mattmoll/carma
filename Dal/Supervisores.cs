...
namespace Carm.Dal
{
    ...
    /// <summary>
    /// Modulo DAL de Acceso a la tabla: Supervisores
    /// </summary>
    public static class Supervisores
    {
        //---------------------------------------------------------------
                                      ...
                                      StatMsg p_smResult)
        {
            try {
                ...
                DBRuts.Exec_DS(p_dbcAccess,
                               "TNGS_Carm..SUPERVISORES_CHKVERSION",
                               new DbParameter[] {

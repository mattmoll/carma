...
namespace Carm.Dal
{
    ...
    /// <summary>
    /// Modulo DAL de Acceso a la tabla: TipoVend
    /// </summary>
    public static class TVendedores
    {
        //---------------------------------------------------------------

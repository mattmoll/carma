...
namespace Carm.Dal
{
    ...
    // Sistema                  : Carm
    // Clase para Administrar   : Categorias de las Llamada
    // Basada en la Tabla       : CategoriasLlamada
    //----------------------------------------------------------------------------
    ...
    /// <summary>
    /// Modulo DAL de Acceso a la tabla: CategoriasLlamada
    /// </summary>
    public static class CategoriasLlamada
    {
        //---------------------------------------------------------------
                             ...
                             StatMsg p_smResult)
        {
            try {
                ...
                return DBRuts.Exec_DS(p_dbcAccess,
                                      "TNGS_Carm..CATEGORIASLLAMADA_UP",
                                      new DbParameter[] {
                                      ...
                                      StatMsg p_smResult)
        {
            try {
                ...
                DBRuts.Exec_DS(p_dbcAccess,
                               "TNGS_Carm..CATEGORIASLLAMADA_CHKVERSION",
                               new DbParameter[] {
                                 ...
                                 StatMsg p_smResult)
        {
            try {
                ...
                return DBRuts.Exec_DS(p_dbcAccess,
                                      "TNGS_Carm..CATEGORIASLLAMADA_SEARCH",
                                      new DbParameter[] {
                                          p_dbcAccess.MakeParam("@ctl_rcd_cod", p_strCod),
                                          p_dbcAccess.MakeParam("@onlyactive", (p_bOnlyActive ? 1 : 0))
                                      },
                                     ...
                                     StatMsg p_smResult)
        {
            ...
            try {
                ...
                DBRuts.Exec_DS(p_dbcAccess,
                               "TNGS_Carm..CATEGORIASLLAMADA_GETMAXKEY",
                               new DbParameter[] {
                                 ...
                                 StatMsg p_smResult)
        {
            try {
                ...
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Carm..CATEGORIASLLAMADA_INSERT",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@ctl_rcd_cod", p_strCod),
                                 ...
                                 StatMsg p_smResult)
        {
            try {
                ...
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Carm..CATEGORIASLLAMADA_DELETE",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@ctl_rcd_cod", p_strCod),
                                       p_dbcAccess.MakeParam("@usuario", DBConn.Usuario)
                                   }
                                 ...
                                 StatMsg p_smResult)
        {
            try {
                // Borramos el registro
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Carm..CATEGORIASLLAMADA_RECALL",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@ctl_rcd_cod", p_strCod),
                                       p_dbcAccess.MakeParam("@usuario", DBConn.Usuario)
                                   }
                               ...
                               StatMsg p_smResult)
        {
            try {
                // Borramos el registro
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Carm..CATEGORIASLLAMADA_DROP",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@ctl_rcd_cod", p_strCod),
                                       p_dbcAccess.MakeParam("@usuario", DBConn.Usuario)
                                   }
                               ...
                               StatMsg p_smResult)
        {
            try {
                // Borramos el registro
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Carm..CATEGORIASLLAMADA_PACK",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@usuario", DBConn.Usuario)
                                   }
                                  );

...
namespace Carm.Dal
{
    ...
    //----------------------------------------------------------------------------
    // Fecha                    : 08/06/2021 01:50
    // Sistema                  : Carm
    // Clase para Administrar   : Parentescos
    // Basada en la Tabla       : Parentescos
    //----------------------------------------------------------------------------
    ...
    /// <summary>
    /// Modulo DAL de Acceso a la tabla: Parentescos
    /// </summary>
    public static class Parentescos
    {
                                      ...
                                      StatMsg p_smResult)
        {
            try {
                ...
                DBRuts.Exec_DS(p_dbcAccess,
                               "TNGS_Carm..PARENTESCOS_CHKVERSION",
                               new DbParameter[] {
                                            ...
                                            StatMsg p_smResult)
        {
            try {
                ...
                p_dtResult.Columns["prt_rcd_cod"].Caption= "V1CodigoCN1";
                p_dtResult.Columns["prt_des_des"].Caption= "V1DescripcionCN1";

...
namespace Carm.Dal
{
    ...
    /// <summary>
    /// Modulo DAL de Acceso a la tabla: Servicios
    /// </summary>
    public static class Servicios
    {
                                      ...
                                      StatMsg p_smResult)
        {
            try {
                ...
                DBRuts.Exec_DS(p_dbcAccess,
                               "TNGS_Carm..SERVICIOS_CHKVERSION",
                               new DbParameter[] {
                                   p_dbcAccess.MakeParam("@srv_cod_cod", p_strCod),
                                 ...
                                 StatMsg p_smResult)
        {
            try {
                ...
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Carm..SERVICIOS_INSERT",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@srv_cod_cod", p_strCod),
                                       p_dbcAccess.MakeParam("@srv_des_des", p_strDes),
                                       p_dbcAccess.MakeParam("@srv_xld_explicacion", p_strExplicacion),
        ...
        /// <param name="p_strTabla">Nombre de la tabla a llenar</param>
        /// <param name="p_smResult">Estado final de la operacion</param>
        public static int GetServiciosFull(DBConn p_dbcAccess,
                                           ref DataSet p_dsResult,
                                           string p_strTabla,
                                           StatMsg p_smResult)
        {
            try {
                return DBRuts.Exec_DS(p_dbcAccess,
                                      "TNGS_Carm..SERVICIOS_GETSERVICIOSFULL",
                                      new DbParameter[] {
                                          p_dbcAccess.MakeParam("@usuario", DBConn.Usuario)
                                      },
                                      ref p_dsResult, p_strTabla);

...
namespace Carm.Dal
{
    ...
    // Sistema                  : Carm
    // Clase para Administrar   : Resultados de la entrevista
    // Basada en la Tabla       : ResEntrevista
    //----------------------------------------------------------------------------
    ...
    /// <summary>
    /// Modulo DAL de Acceso a la tabla: ResEntrevista
    /// </summary>
    public static class ResEntrevista
    {
        //---------------------------------------------------------------
                                      ...
                                      StatMsg p_smResult)
        {
            try {
                ...
                DBRuts.Exec_DS(p_dbcAccess,
                               "TNGS_Carm..RESENTREVISTA_CHKVERSION",
                               new DbParameter[] {
                                   p_dbcAccess.MakeParam("@ren_rcd_cod", p_strCod),
                                 ...
                                 StatMsg p_smResult)
        {
            try {
                ...
                return DBRuts.Exec_DS(p_dbcAccess,
                                      "TNGS_Carm..RESENTREVISTA_SEARCH",
                                      new DbParameter[] {
                                          p_dbcAccess.MakeParam("@ren_rcd_cod", p_strCod),
                                          p_dbcAccess.MakeParam("@onlyactive", (p_bOnlyActive ? 1 : 0))
                                      },
                                     ...
                                     StatMsg p_smResult)
        {
            ...
            try {
                ...
                DBRuts.Exec_DS(p_dbcAccess,
                               "TNGS_Carm..RESENTREVISTA_GETMAXKEY",
                               new DbParameter[] {
                                 ...
                                 StatMsg p_smResult)
        {
            try {
                ...
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Carm..RESENTREVISTA_INSERT",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@ren_rcd_cod", p_strCod),
                                       p_dbcAccess.MakeParam("@ren_des_des", p_strDes),
                                       p_dbcAccess.MakeParam("@ren_cd1_codfiltro", p_strCodfiltro),
                                 ...
                                 StatMsg p_smResult)
        {
            try {
                ...
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Carm..RESENTREVISTA_UPDATE",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@ren_rcd_cod", p_strCod),
                                       p_dbcAccess.MakeParam("@ren_des_des", p_strDes),
                                       p_dbcAccess.MakeParam("@ren_cd1_codfiltro", p_strCodfiltro),
                                 ...
                                 StatMsg p_smResult)
        {
            try {
                ...
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Carm..RESENTREVISTA_DELETE",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@ren_rcd_cod", p_strCod),
                                       p_dbcAccess.MakeParam("@usuario", DBConn.Usuario)
                                   }
                                 ...
                                 StatMsg p_smResult)
        {
            try {
                // Borramos el registro
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Carm..RESENTREVISTA_RECALL",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@ren_rcd_cod", p_strCod),
                                       p_dbcAccess.MakeParam("@usuario", DBConn.Usuario)
                                   }
                                            ...
                                            StatMsg p_smResult)
        {
            try {
                ...
                p_dtResult.Columns["ren_rcd_cod"].Caption= "V1CódigoCN1";
                p_dtResult.Columns["ren_cd1_codfiltro"].Caption= "V1Genera ContratoCN1";
                p_dtResult.Columns["ren_des_des"].Caption= "V1DescripciónCN1";
